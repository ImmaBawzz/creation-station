...
- GitHub Actions CI must rerun after the npm 10 `package-lock.json` synchronization and route context type fixes; earlier PR runs failed at `npm ci` and then `npx tsc --noEmit`.
