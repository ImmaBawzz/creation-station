...
- GitHub Actions CI must rerun after the npm 10 `package-lock.json` synchronization, route context type, and FFprobe test fixes; earlier PR runs failed at `npm ci`, `npx tsc --noEmit`, and then `npm test`.
