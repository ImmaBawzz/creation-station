...
- GitHub Actions CI rerun and review for PR #1, the `v1.7.0-alpha.2` pre-release prep PR, after the npm 10 lockfile synchronization fix.
...
| 1a | P0 | Validate `v1.7.0-alpha.2` release-prep PR | Stage 1 | Wait for the CI rerun and review PR #1 without tagging or releasing. |
